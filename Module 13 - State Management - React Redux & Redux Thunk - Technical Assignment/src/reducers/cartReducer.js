...
const cartReducer = (state = initState, action) => {
  ...
  if (action.type === ADD_TO_CART) {
    ...
    const isExist = state.addedItems.find(
    ...
    if (isExist) {
      ...
      return {
        ...state,
        addedItems: [...state.addedItems, foundItem],
        total: state.total + foundItem.price,
      };
    }
  }
  if (action.type === REMOVE_ITEM) {
    ...
    return {
      ...state,
      addedItems: newItems,
      total: state.total - foundItem.price * foundItem.quantity,
    };
  }
